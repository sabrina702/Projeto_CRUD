	...
	<div id="container" class="container-fluid">
		            			...
		            			<tr>
		            				...
		            				<td class="actions">
				                        <a class="btn btn-danger btn-xs modal-remove"
				                           user-seller-id="${vendedor.getId()}" 
				                           user-seller-name="${vendedor.getName()}" data-toggle="modal" 
		            				...
		            				<td class="actions">
				                        <a class="btn btn-info btn-xs" 
				                           href="${pageContext.request.contextPath}/seller/update?sellerId=${vendedor.getId()}" >
				                           <span class="glyphicon glyphicon-edit"></span>
				                        </a>
				                    </td>
		            			</tr>
		...
		<script type="text/javascript">$(document).ready(function () {
		    ...
		    $(".modal-remove").click(function () {
	            ...
	            $(".modal-body #hiddenValue").text("o vendedor de nome"+sellerName+"");
